...
public class drillsno1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_drillsno1);
                    ...
                    if(gunshotPeriodCounter == 0){
                        ...
                        if(isRunning == true){
                            ...
                            if(shotCounter ==1) {
                                ...
                                // variables for inserting data in database table.
                                s4 = shot4Time.getText().toString();
                                sp3 = splitTime3.getText().toString();
                                last = lastShotTime.getText().toString();

                                boolean result = obj.insertdata(s1,s2,sp1,s3,sp2,s4,sp3,s5,sp4,last);
                                if (result = true)
                                    Toast.makeText(drillsno1.this, "Data Inserted", Toast.LENGTH_LONG).show();

                                else
                                    Toast.makeText(drillsno1.this, "Data not Inserted", Toast.LENGTH_LONG).show();
