...
public class shottimer extends AppCompatActivity {

    public calibrate userCalibration = new calibrate();
...
//    private Button shotButton;
    ...
    private TextView shot4Time;
    private TextView shot5Time;
    private TextView splitTime1;
    private TextView splitTime2;
    private TextView splitTime3;
    private TextView splitTime4;
    ...
    //CALIBRATION Values
    final int gunShotPeriod = 10;
    int gunShotThreshold = 18;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_shottimer);
        ...
        shot4Time = (TextView) findViewById(R.id.shot4);
        shot5Time = (TextView) findViewById(R.id.shot5);

        splitTime1 = (TextView) findViewById(R.id.split1);
        splitTime2 = (TextView) findViewById(R.id.split2);
        splitTime3 = (TextView) findViewById(R.id.split3);
        splitTime4 = (TextView) findViewById(R.id.split4);
        ...
        gunShotThreshold = userCalibration.getCalVal();
                    ...
                    if(gunshotPeriodCounter == 0){
                        ...
                        if(isRunning == true){
                            ...
                            if(shotCounter ==1) {
                                ...
                                shot4Time.setText(lastShotTime.getText());
                                splitTime3.setText(getSplitTime(shot3Time.getText().toString(), shot4Time.getText().toString()));
                            }
                            else if(shotCounter ==5){
                                shot5Time.setText(lastShotTime.getText());
                                splitTime4.setText(getSplitTime(shot4Time.getText().toString(), shot5Time.getText().toString()));
    ...
    private void resetOutputStrings(){
        ...
        shot4Time.setText("00:00");
        shot5Time.setText("00:00");

        splitTime1.setText("00:00");
        splitTime2.setText("00:00");
        splitTime3.setText("00:00");
        splitTime4.setText("00:00");
    }
